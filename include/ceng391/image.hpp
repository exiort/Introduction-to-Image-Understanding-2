...
public:
        ...
        void smooth(float sigma_x, float sigma_y) { smooth_x(sigma_x); smooth_y(sigma_y); }

        short* deriv_x() const;
        short* deriv_y() const;
        
        void rotate(float theta, Image* out, bool bilinear, bool rotate_center) const;   
...
private:
        ...
        float* create_gaussian_filter_kernel(int l, float sigma);
